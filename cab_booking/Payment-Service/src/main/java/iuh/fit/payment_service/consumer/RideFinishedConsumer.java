...
public class RideFinishedConsumer {
    ...
    public void consumeRideFinishedEvent(
        ...
        try {
            ...
            log.info("[Consumer] Received ride.finished - key={}, partition={}, offset={}, rideId={}, driverId={}, paymentMethod={}, finalFare={}",
                    key, partition, offset, event.getRideId(), event.getDriverId(),
                    event.getPaymentMethod(), event.getFinalFare());
            paymentSagaService.settleDriverEarningFromRideFinished(event);
            acknowledgment.acknowledge();
            log.info("[Consumer] Successfully processed ride.finished settlement - key={}", key);
        } catch (Exception e) {
